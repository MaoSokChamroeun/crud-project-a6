...
<body>
    <div class ="container">
            ...
            <input type="text" name="txt-name" value="<?php echo $edit_data['name'] ?? ''; ?>">

            <label for="">Product Name</label>
            <input type="text" name="txt-product" value="<?php echo $edit_data['p_name'] ?? ''; ?>">

            <label for="">Quantity</label>
            <input type="text" name="txt-qty" value="<?php echo $edit_data['qty'] ?? ''; ?>">

            <label for="">Status</label>
            <select name="txt-status">
                <option value="">Select status</option>
                <option value="Available" <?php if (($edit_data['status'] ?? '') == 'Available') echo 'selected'; ?>>Available</option>
                <option value="Out of Stock" <?php if (($edit_data['status'] ?? '') == 'Out of Stock') echo 'selected'; ?>>Out of Stock</option>
            </select>

              <div class = "image-container">
                <label for="">Upload Image</label>
                <div class = "box-image" id="box-image">
                     <input class = "input-img" type="file" name="txt-image" id = "txt-image" value="<?php echo $edit_data['img'] ?? ''; ?>" >
            ...
            <input type="text" name="txt-email" value="<?php echo $edit_data['email'] ?? ''; ?>">

            <label for="">Password</label>
            <input type="text" name="txt-password" value="<?php echo $edit_data['password'] ?? ''; ?>">
